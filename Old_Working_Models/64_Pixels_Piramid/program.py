...
with tf.name_scope('convolutional2') as scope:
    ...
    smaller_matrix_conv4_flat = tf.reshape(smaller_matrix_conv2, [-1, (IMAGE_SIDE / 4) * (IMAGE_SIDE / 4) * NEURONS * 2])
    
    
#with tf.name_scope('convolutional3') as scope:
    # hidden inputs
#    weight_matrix_conv3 = weight_variable([5, 5, 64, 128],name="weight_matrix_conv3")
#    bias_vector_conv3 = bias_variable([128], name="bias_vector_conv3")
